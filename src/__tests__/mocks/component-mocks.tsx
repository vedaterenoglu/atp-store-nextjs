...
export const pageMocks = {
  ...
  ProductsPage: jest.fn(
    ({ products }: { products: Array<{ id: string; imageUrl: string }> }) =>
      React.createElement('div', { 'data-testid': 'products-page' }, [
        React.createElement(
          'div',
          { key: 'count', 'data-testid': 'products-count' },
...
export const uiComponentMocks = {
  ...
  Card: jest.fn(
    ({
      ...
      React.createElement(
        'div',
        {
          'data-testid': props['data-testid'] || 'error-card',
          className,
          ...props,
        },
        children
  ...
  CardFooter: jest.fn(
    ({
      ...
      React.createElement(
        'div',
        { 'data-testid': 'card-footer', className },
        children
      )
  ),
...
export const selectMocks = {
  ...
  SelectValue: jest.fn(({ placeholder }: { placeholder?: string }) =>
    React.createElement(
      'span',
      { 'data-testid': 'select-value', 'data-placeholder': placeholder },
      placeholder
    )
  ),
}
...
export const formMocks = {
  ...
  FormControl: jest.fn(({ children }: { children?: React.ReactNode }) =>
    React.createElement(React.Fragment, null, children)
  ),
  ...
  FormMessage: jest.fn(() =>
    React.createElement('span', { 'data-testid': 'form-message' })
  ),
}
...
export const reactHookFormMocks = {
  ...
  Controller: jest.fn(
    ({ render }: { render: (props: unknown) => React.ReactElement }) =>
      render({ field: { onChange: jest.fn(), value: '', name: 'field' } })
  ),
 ...
 */
export const mockAutoplay = jest.fn(
...
export const lucideIconMocks = {
  ...
  X: jest.fn(() => React.createElement('span', { 'data-testid': 'x-icon' })),
  Send: jest.fn(({ className }: { className?: string }) =>
    React.createElement(
      'span',
      { 'data-testid': 'send-icon', className },
      'Send'
    )
  ),
  AlertCircle: jest.fn(({ className }: { className?: string }) =>
    React.createElement(
      'span',
      { 'data-testid': 'alert-circle-icon', className },
      '!'
    )
  ),
  Loader2: jest.fn(({ className }: { className?: string }) =>
    React.createElement(
      'span',
      { 'data-testid': 'loader-icon', className },
      'Loading'
    )
  ),
  Filter: jest.fn(({ className }: { className?: string }) =>
    React.createElement(
      'span',
      { 'data-testid': 'filter-icon', className },
      'Filter Icon'
    )
  ),
  Search: jest.fn(({ className }: { className?: string }) =>
    React.createElement(
      'span',
      { 'data-testid': 'search-icon', className },
      'Search Icon'
    )
  ),
  ...
  ArrowRight: jest.fn(({ className }: { className?: string }) =>
    React.createElement(
      'span',
      { 'data-testid': 'arrow-right-icon', className },
      '→'
    )
  ),
}
...
export const campaignComponentMocks = {
  ...
  SliderControls: jest.fn(
    ({
      ...
      React.createElement('div', { 'data-testid': 'slider-controls' }, [
        ...
        React.createElement(
          'span',
          { key: 'current', 'data-testid': 'current-index' },
          String(current)
        ),
        React.createElement(
          'span',
          { key: 'total', 'data-testid': 'total-items' },
          String(total)
        ),
  ...
  CampaignGridError: jest.fn(
    ({ error, onRetry }: { error: Error; onRetry?: () => void }) => {
      return React.createElement(
        'div',
        { 'data-testid': 'grid-error', 'data-has-retry': !!onRetry },
        [
          React.createElement(
            'span',
            { key: 'error' },
  ...
  QuantityCounter: jest.fn(
    ({
      ...
      React.createElement(
        'div',
        { 'data-testid': 'quantity-counter', 'data-disabled': disabled },
        [
          React.createElement(
            'button',
            {
          ...
          React.createElement(
            'span',
            { key: 'display', 'data-testid': 'quantity-display' },
            String(quantity)
          ),
          React.createElement(
            'button',
      ...
      React.createElement(
        ...
        [
          error
            ? React.createElement(
                'div',
                { key: 'error', 'data-testid': 'error-display' },
                [
                  `Error: ${error.message}`,
                  onRetry
                    ? React.createElement(
...
export const testUtilityComponents = {
  ...
  ComponentWithLifecycleError: class ComponentWithLifecycleError extends React.Component {
    static displayName = 'ComponentWithLifecycleError'
